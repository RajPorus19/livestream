...
SECRET_KEY = "django-insecure--1)z@t^qd--_(-6z*$(-bawo6^g1(^a@p=32!ve!u$8mhi8*ll"
...
# django react integretion
STATICFILES_DIRS = [os.path.join(BASE_DIR, "react-ui/build/static")]
